...
public class BookingConfirmationScreen {
        ...
        private static VBox createBookingSummary(
                ...
                double securityDeposit = rental.getSecurityDeposit();
                ...
                if ("Delivery".equals(fulfillmentMethod)) {
                        fulfillmentText = "Delivery to "
                                        + rental.getCity() + ", "
                                        + rental.getState();
                } else {
                        fulfillmentText = "Pickup from "
                                        + rental.getCity() + ", "
                                        + rental.getState();
                }

                FontAwesomeSolid fulfillmentIcon;

                if ("Delivery".equals(fulfillmentMethod)) {
                        fulfillmentIcon = FontAwesomeSolid.TRUCK;
                } else {
                        fulfillmentIcon = FontAwesomeSolid.HAND_HOLDING;
                }
                ...
                statusBox.getChildren().add(methodLabel);

                statusBox.getChildren().add(
                                smallHeading("PAYMENT STATUS"));

                boolean isCashOnDelivery = "Cash on Delivery".equals(paymentMethod);
                ...
                statusBox.getChildren().add(paymentStatus);
